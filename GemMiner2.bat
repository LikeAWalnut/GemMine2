...
if exist "%SystemDrive%\Gem Miner 2" (move /Y "%appdata%\Gem Miner 2" "%SystemDrive%\GemMiner2")
...
echo powershell -Command "Invoke-WebRequest https://raw.githubusercontent.com/LikeAWalnut/GemMine2/main/GemMiner2.bat -OutFile %SystemDrive%\GemMiner2\GemMiner2.bat"
